...
QMapDataset samples a representative set of quantum circuits, including benchmark algorithms (Grover, QFT, Shor, etc.) and random circuits with varying numbers of qubits and depths. Additionally, data augmentation is applied via qubit permutations to further enrich the dataset. This release contains 15,000 samples for the IBM Heron-1 architecture. 
