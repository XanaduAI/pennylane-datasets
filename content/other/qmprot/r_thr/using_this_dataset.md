...
This dataset contains various quantum properties that represent and describe the threonine radical under certain conditions.  The dataset includes molecular geometries, the Hamiltonian, energies, and other descriptors that can be used to analyze the molecule’s behavior and build the entire threonine amino acid.
...
ds = qml.data.load('other', name='r-thr')
