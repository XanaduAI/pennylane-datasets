...
This dataset contains various quantum properties that represent and describe the glycine amino acid under certain conditions.  The dataset includes molecular geometries, the Hamiltonian, energies, and other descriptors that can be used to analyze the molecule’s behavior and build longer peptides.
...
ds = qp.data.load('other', name='gly')
