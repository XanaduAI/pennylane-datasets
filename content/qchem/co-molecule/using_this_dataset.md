This dataset contains various quantum properties that represent and describe the CO molecule with different [bond lengths](https://en.wikipedia.org/wiki/Bond_length).
