This dataset contains various quantum properties that represent and describe the N2H4 molecule with a specific [bond length](https://en.wikipedia.org/wiki/Bond_length).
