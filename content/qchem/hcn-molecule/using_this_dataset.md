This dataset contains various quantum properties that represent and describe the HCN molecule with different [bond angles](https://en.wikipedia.org/wiki/Molecular_geometry).
