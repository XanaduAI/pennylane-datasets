This dataset contains various quantum properties that represent and describe the H8 molecule with different [bond lengths](https://en.wikipedia.org/wiki/Bond_length).
