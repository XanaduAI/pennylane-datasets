This dataset contains various quantum properties that represent and describe the O3 molecule with a specific [bond length](https://en.wikipedia.org/wiki/Bond_length).
