...
|`rx_error`|`pennylane.data.attributes.list.DatasetList`|List containing the errors of RX gate (for each physical qubit)|
...
|`cz`|`pennylane.data.attributes.list.DatasetList`|List containing the errors of CZ gate (for each connected pair of physical qubits)|
